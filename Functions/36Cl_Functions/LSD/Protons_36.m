function P = Protons_36(h,Rct,s,consts,nuclide)
...
%  debut de l'ancienne boucle
    ...
    elseif nuclide == 36        
        P.P36Cap = (trapz(E,phiPtot.*(Inrc*consts.CapxCl36),2).*consts.Natoms36Ca.*1e-27.*3.1536e7)'; 
        P.P36Kp = (trapz(E,phiPtot.*(Inrc*consts.KpxCl36),2).*consts.Natoms36K.*1e-27.*3.1536e7)';  
        P.P36Tip = (trapz(E,phiPtot.*(Inrc*consts.TipxCl36),2).*consts.Natoms36Ti.*1e-27.*3.1536e7)'; 
        P.P36Fep = (trapz(E,phiPtot.*(Inrc*consts.FepxCl36),2).*consts.Natoms36Fe.*1e-27.*3.1536e7)'; 
    end
