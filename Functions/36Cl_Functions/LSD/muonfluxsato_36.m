function out = muonfluxsato_36(z,h,Rc,s,consts,dflag)
...
mflux = Muons_36(h,Rc,s);%Generates muon flux at site from Sato et al. (2008) model
mfluxRef = Muons_36(1013.25,0,consts.SPhiInf); %Generates SLHL muon flux from Sato et al. (2008) model
...
%    figure(1);hold on;plot(-cumint,-zz);plot(phi_vert_site,-z,'-.');plot(cumintz,-zzz)
