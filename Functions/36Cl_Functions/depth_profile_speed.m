...
N_samples = length(z_vector);
    ...
    for i=1:length(z_vector)
            ...
            % get Production rate within the sample at surface z=.0;
                ...
                if(flag.plotP)
                P36_s_percent = P36_s./P36_tot.*100;
                P36_th_percent = P36_th./P36_tot.*100;
                P36_eth_percent = P36_eth./P36_tot.*100;
                P36_mu_percent = P36_mu./P36_tot.*100;
                P36_rad_percent = P36_rad./P36_tot.*100;
